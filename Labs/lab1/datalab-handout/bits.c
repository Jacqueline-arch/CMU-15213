...
long isPalindrome(long x) {
    ...
    int hi32 = (x>>32) & mask32;
    int lo32 = x & mask32;
    int mask 16 = 0xffff;
    int newhi16 = (lo32 & mask16) << 16;
    int newlo16 = (lo32>>16) & mask16;
    int loR16 = newhi16 | newlo16;
    int mask8 = 0x00ff00ff;
    int newhi8 = (loR16&mask8) << 8;
    int newlo8 = (loR16>>8)&mask8;
    int loR8 = newhi8 | newlo8
    int mask4 = 0x0f0f0f0f;
    int newhi8 = (loR8&mask4)<<4;
    int newlo8 = (loR8>>4) & mask4;
    int loR4 = newhi8 | newlo8;
    int mask2 = 0x33333333;
    int newhi2 = (loR4&mask2)<<2;
    int newlo2 = (loR4 >> 2) & mask2;
    int loR2 = newhi2 | newlo2;
    int mask1 = 0x55555555;
    int newhi1 = (loR2&mask1)<<1;
    int newlo1 = (loR2>>1)&mask1;
    int loR32 = newhi1 | newlo1;
    return !(hi32 ^ loR32);
}
/*
